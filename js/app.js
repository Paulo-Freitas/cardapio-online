...
var CELULAR_EMPRESA = '5591981722995';
...
cardapio.metodos = {
    ...
    // diminuir a quantidadedo item no cardapio
    ...
    // aumentar a quantidadedo item no cardapio
        ...
        if (qntdAtual > 0) {
           ...
           var categoria = $(".container-menu a.active").attr('id').split('menu-')[1];
            ...
            if (item.length > 0) {
                ...
                // caso ainda não exista o item no carinho, adiciona ele
                else {
                ...
                cardapio.metodos.mensagem('Item adiconado ao carrinho', 'green')
                $("#qntd-" + id).text(0);
    ...
    // atualiza o badge de totais os botôes "Meu carrinho"
    atualizarBadgeTotal: () => {
   ...
   // altera os textos e exibe os botões das etapas
            ...
            if(validacep.test(cep)) {
                ...
                $.getJSON("https://viacep.com.br/ws/" + cep + "/json/?callback=?", function (dados) {
                    ...
                    if(!("erro" in dados)) {
                        ...
                        //atualizar os campos com o s valores retornados
                        ...
                        cardapio.metodos.mensagem('CEP não encontrado. Preencha as informações mnaualmente.');
                        $("#txtEndereco").focus();
                    }
                })
    ...
    // carregar o link do botão WhatsApp-social
    carregarBotaoWhatsApp: () => {

        var texto = 'Olá! gostaria retirar uma *duvida*'
